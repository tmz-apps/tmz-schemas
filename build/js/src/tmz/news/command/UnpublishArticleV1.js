...
export default class UnpublishArticleV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:news:command:unpublish-article:1-0-0', UnpublishArticleV1,
      [],
      [
...
MessageResolver.register('tmz:news:command:unpublish-article', UnpublishArticleV1);

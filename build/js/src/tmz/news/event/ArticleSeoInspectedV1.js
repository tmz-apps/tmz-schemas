// @link https://schemas.tmz.com/json-schema/tmz/news/event/article-seo-inspected/1-0-0.json#
...
export default class ArticleSeoInspectedV1 extends Message {
  /**
   * @private
   *
   * @returns {Schema}
...
const M = ArticleSeoInspectedV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:news:event:article-seo-inspected:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:news:event:article-seo-inspected';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-seo-inspected:v1';
...
TrinitiSysSeoInspectedV1Mixin(M);

...
export default class GetPollRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:apollo:request:get-poll-request:1-0-0', GetPollRequestV1,
      [],
      [
...
MessageResolver.register('tmz:apollo:request:get-poll-request', GetPollRequestV1);

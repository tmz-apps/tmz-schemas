...
export default class GetPollHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:apollo:request:get-poll-history-response:1-0-0', GetPollHistoryResponseV1,
      [],
      [
...
MessageResolver.register('tmz:apollo:request:get-poll-history-response', GetPollHistoryResponseV1);

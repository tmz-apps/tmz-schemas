// @link https://schemas.tmz.com/json-schema/tmz/apollo/node/poll/1-0-0.json#
...
export default class PollV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:apollo:node:poll:1-0-0', PollV1,
      [],
      [
...
MessageResolver.register('tmz:apollo:node:poll', PollV1);

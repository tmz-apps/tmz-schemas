...
export default class PollMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:apollo:event:poll-marked-as-pending:1-0-0', PollMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:apollo:event:poll-marked-as-pending', PollMarkedAsPendingV1);

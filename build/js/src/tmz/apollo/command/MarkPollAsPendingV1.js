...
export default class MarkPollAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:apollo:command:mark-poll-as-pending:1-0-0', MarkPollAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:apollo:command:mark-poll-as-pending', MarkPollAsPendingV1);

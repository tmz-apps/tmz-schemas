// @link http://schemas.tmz.com/json-schema/tmz/sys/command/delete-flagset/1-0-0.json#
...
export default class DeleteFlagsetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:sys:command:delete-flagset:1-0-0', DeleteFlagsetV1,
      [],
      [
...
MessageResolver.register('tmz:sys:command:delete-flagset', DeleteFlagsetV1);

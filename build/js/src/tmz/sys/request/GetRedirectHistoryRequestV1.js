...
export default class GetRedirectHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:sys:request:get-redirect-history-request:1-0-0', GetRedirectHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:sys:request:get-redirect-history-request', GetRedirectHistoryRequestV1);

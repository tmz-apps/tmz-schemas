// @link https://schemas.tmz.com/json-schema/tmz/sys/request/list-all-picklists-response/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:sys:request:list-all-picklists-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:sys:request:list-all-picklists-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:sys:request:list-all-picklists-response:v1';

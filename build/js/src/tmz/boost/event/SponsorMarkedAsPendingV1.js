...
export default class SponsorMarkedAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:boost:event:sponsor-marked-as-pending:1-0-0', SponsorMarkedAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:boost:event:sponsor-marked-as-pending', SponsorMarkedAsPendingV1);

...
export default class MarkSponsorAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:boost:command:mark-sponsor-as-pending:1-0-0', MarkSponsorAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:boost:command:mark-sponsor-as-pending', MarkSponsorAsPendingV1);

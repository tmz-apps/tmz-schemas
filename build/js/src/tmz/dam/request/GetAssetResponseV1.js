...
export default class GetAssetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:dam:request:get-asset-response:1-0-0', GetAssetResponseV1,
      [],
      [
...
MessageResolver.register('tmz:dam:request:get-asset-response', GetAssetResponseV1);

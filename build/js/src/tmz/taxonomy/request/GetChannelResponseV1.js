...
export default class GetChannelResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:taxonomy:request:get-channel-response:1-0-0', GetChannelResponseV1,
      [],
      [
...
MessageResolver.register('tmz:taxonomy:request:get-channel-response', GetChannelResponseV1);

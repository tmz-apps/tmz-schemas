// @link https://schemas.tmz.com/json-schema/tmz/canvas/command/publish-page/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:canvas:command:publish-page:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:canvas:command:publish-page';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:publish-page:v1';

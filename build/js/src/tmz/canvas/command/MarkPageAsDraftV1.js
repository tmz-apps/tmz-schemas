...
export default class MarkPageAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:canvas:command:mark-page-as-draft:1-0-0', MarkPageAsDraftV1,
      [],
      [
...
MessageResolver.register('tmz:canvas:command:mark-page-as-draft', MarkPageAsDraftV1);

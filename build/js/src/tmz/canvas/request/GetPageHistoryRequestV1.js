...
export default class GetPageHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:canvas:request:get-page-history-request:1-0-0', GetPageHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:canvas:request:get-page-history-request', GetPageHistoryRequestV1);

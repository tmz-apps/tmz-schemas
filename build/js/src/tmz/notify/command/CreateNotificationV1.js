...
export default class CreateNotificationV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:notify:command:create-notification:1-0-0', CreateNotificationV1,
      [],
      [
...
MessageResolver.register('tmz:notify:command:create-notification', CreateNotificationV1);

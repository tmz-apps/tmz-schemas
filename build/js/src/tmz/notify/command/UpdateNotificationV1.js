// @link https://schemas.tmz.com/json-schema/tmz/notify/command/update-notification/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:notify:command:update-notification:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:notify:command:update-notification';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:notify:command:update-notification:v1';

...
export default class GetVideoRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:ovp:request:get-video-request:1-0-0', GetVideoRequestV1,
      [],
      [
...
MessageResolver.register('tmz:ovp:request:get-video-request', GetVideoRequestV1);

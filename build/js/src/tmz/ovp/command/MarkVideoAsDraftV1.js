...
export default class MarkVideoAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:ovp:command:mark-video-as-draft:1-0-0', MarkVideoAsDraftV1,
      [],
      [
...
MessageResolver.register('tmz:ovp:command:mark-video-as-draft', MarkVideoAsDraftV1);

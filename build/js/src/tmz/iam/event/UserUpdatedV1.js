// @link http://schemas.tmz.com/json-schema/tmz/iam/event/user-updated/1-0-0.json#
...
export default class UserUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:event:user-updated:1-0-0', UserUpdatedV1,
      [],
      [
...
MessageResolver.register('tmz:iam:event:user-updated', UserUpdatedV1);

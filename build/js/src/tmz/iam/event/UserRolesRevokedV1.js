// @link https://schemas.tmz.com/json-schema/tmz/iam/event/user-roles-revoked/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:event:user-roles-revoked:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:event:user-roles-revoked';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:event:user-roles-revoked:v1';

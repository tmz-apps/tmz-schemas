...
export default class AppRolesRevokedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:event:app-roles-revoked:1-0-0', AppRolesRevokedV1,
      [],
      [
...
MessageResolver.register('tmz:iam:event:app-roles-revoked', AppRolesRevokedV1);

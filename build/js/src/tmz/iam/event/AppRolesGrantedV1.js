...
export default class AppRolesGrantedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:event:app-roles-granted:1-0-0', AppRolesGrantedV1,
      [],
      [
...
MessageResolver.register('tmz:iam:event:app-roles-granted', AppRolesGrantedV1);

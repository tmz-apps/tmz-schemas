...
export default class UserRolesGrantedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:event:user-roles-granted:1-0-0', UserRolesGrantedV1,
      [],
      [
...
MessageResolver.register('tmz:iam:event:user-roles-granted', UserRolesGrantedV1);

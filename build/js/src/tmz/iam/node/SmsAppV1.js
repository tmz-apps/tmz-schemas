...
const M = SmsAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:node:sms-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:node:sms-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:node:sms-app:v1';

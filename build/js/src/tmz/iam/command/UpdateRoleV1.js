// @link https://schemas.tmz.com/json-schema/tmz/iam/command/update-role/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:command:update-role:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:command:update-role';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:command:update-role:v1';

// @link https://schemas.tmz.com/json-schema/tmz/iam/command/update-app/1-0-0.json#
...
const M = UpdateAppV1;
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:command:update-app:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:command:update-app';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:command:update-app:v1';

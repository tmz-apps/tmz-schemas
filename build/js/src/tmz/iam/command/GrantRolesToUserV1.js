...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:command:grant-roles-to-user:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:command:grant-roles-to-user';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:command:grant-roles-to-user:v1';

...
export default class GetAppHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:request:get-app-history-request:1-0-0', GetAppHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:iam:request:get-app-history-request', GetAppHistoryRequestV1);

// @link https://schemas.tmz.com/json-schema/tmz/iam/request/list-all-roles-response/1-0-0.json#
...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:request:list-all-roles-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:request:list-all-roles-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:request:list-all-roles-response:v1';

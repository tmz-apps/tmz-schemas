...
export default class GetUserHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:request:get-user-history-request:1-0-0', GetUserHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:iam:request:get-user-history-request', GetUserHistoryRequestV1);

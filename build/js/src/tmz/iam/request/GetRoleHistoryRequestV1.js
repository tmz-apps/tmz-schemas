...
export default class GetRoleHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:iam:request:get-role-history-request:1-0-0', GetRoleHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:iam:request:get-role-history-request', GetRoleHistoryRequestV1);

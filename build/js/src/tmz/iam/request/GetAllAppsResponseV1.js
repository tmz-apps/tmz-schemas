...
M.prototype.SCHEMA_ID = M.SCHEMA_ID = 'pbj:tmz:iam:request:get-all-apps-response:1-0-0';
M.prototype.SCHEMA_CURIE = M.SCHEMA_CURIE = 'tmz:iam:request:get-all-apps-response';
M.prototype.SCHEMA_CURIE_MAJOR = M.SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-all-apps-response:v1';

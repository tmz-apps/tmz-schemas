...
export default class ExpireGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:expire-gallery:1-0-0', ExpireGalleryV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:expire-gallery', ExpireGalleryV1);

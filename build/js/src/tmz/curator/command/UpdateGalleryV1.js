...
export default class UpdateGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:update-gallery:1-0-0', UpdateGalleryV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:update-gallery', UpdateGalleryV1);

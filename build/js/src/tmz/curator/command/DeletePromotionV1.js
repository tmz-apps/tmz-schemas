// @link http://schemas.tmz.com/json-schema/tmz/curator/command/delete-promotion/1-0-0.json#
...
export default class DeletePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:delete-promotion:1-0-0', DeletePromotionV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:delete-promotion', DeletePromotionV1);

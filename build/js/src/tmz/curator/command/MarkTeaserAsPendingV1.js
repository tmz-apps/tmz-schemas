...
export default class MarkTeaserAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:mark-teaser-as-pending:1-0-0', MarkTeaserAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:mark-teaser-as-pending', MarkTeaserAsPendingV1);

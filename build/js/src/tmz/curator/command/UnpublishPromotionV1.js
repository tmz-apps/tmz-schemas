...
export default class UnpublishPromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:unpublish-promotion:1-0-0', UnpublishPromotionV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:unpublish-promotion', UnpublishPromotionV1);

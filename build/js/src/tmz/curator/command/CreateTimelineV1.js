...
export default class CreateTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:create-timeline:1-0-0', CreateTimelineV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:create-timeline', CreateTimelineV1);

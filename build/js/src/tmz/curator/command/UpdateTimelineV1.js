// @link http://schemas.tmz.com/json-schema/tmz/curator/command/update-timeline/1-0-0.json#
...
export default class UpdateTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:update-timeline:1-0-0', UpdateTimelineV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:update-timeline', UpdateTimelineV1);

...
export default class MarkPromotionAsPendingV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:mark-promotion-as-pending:1-0-0', MarkPromotionAsPendingV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:mark-promotion-as-pending', MarkPromotionAsPendingV1);

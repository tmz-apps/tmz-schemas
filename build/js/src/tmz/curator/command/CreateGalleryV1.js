...
export default class CreateGalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:create-gallery:1-0-0', CreateGalleryV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:create-gallery', CreateGalleryV1);

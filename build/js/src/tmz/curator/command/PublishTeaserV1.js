...
export default class PublishTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:publish-teaser:1-0-0', PublishTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:publish-teaser', PublishTeaserV1);

...
export default class RenameTimelineV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:rename-timeline:1-0-0', RenameTimelineV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:rename-timeline', RenameTimelineV1);

...
export default class UpdatePromotionV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:command:update-promotion:1-0-0', UpdatePromotionV1,
      [],
      [
...
MessageResolver.register('tmz:curator:command:update-promotion', UpdatePromotionV1);

...
export default class TimelineRenamedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:timeline-renamed:1-0-0', TimelineRenamedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:timeline-renamed', TimelineRenamedV1);

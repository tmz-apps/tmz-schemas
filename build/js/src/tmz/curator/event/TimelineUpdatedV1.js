...
export default class TimelineUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:timeline-updated:1-0-0', TimelineUpdatedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:timeline-updated', TimelineUpdatedV1);

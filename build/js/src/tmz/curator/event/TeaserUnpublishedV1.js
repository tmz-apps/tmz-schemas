...
export default class TeaserUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:teaser-unpublished:1-0-0', TeaserUnpublishedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:teaser-unpublished', TeaserUnpublishedV1);

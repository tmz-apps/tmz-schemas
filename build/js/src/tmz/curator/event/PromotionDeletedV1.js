...
export default class PromotionDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:promotion-deleted:1-0-0', PromotionDeletedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:promotion-deleted', PromotionDeletedV1);

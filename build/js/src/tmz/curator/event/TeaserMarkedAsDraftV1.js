...
export default class TeaserMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:teaser-marked-as-draft:1-0-0', TeaserMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:teaser-marked-as-draft', TeaserMarkedAsDraftV1);

...
export default class GalleryScheduledV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:gallery-scheduled:1-0-0', GalleryScheduledV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:gallery-scheduled', GalleryScheduledV1);

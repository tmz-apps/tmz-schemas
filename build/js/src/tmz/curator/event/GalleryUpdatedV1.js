...
export default class GalleryUpdatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:gallery-updated:1-0-0', GalleryUpdatedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:gallery-updated', GalleryUpdatedV1);

...
export default class GalleryUnpublishedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:gallery-unpublished:1-0-0', GalleryUnpublishedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:gallery-unpublished', GalleryUnpublishedV1);

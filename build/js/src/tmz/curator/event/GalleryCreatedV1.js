...
export default class GalleryCreatedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:gallery-created:1-0-0', GalleryCreatedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:gallery-created', GalleryCreatedV1);

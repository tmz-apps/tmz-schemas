...
export default class TimelineMarkedAsDraftV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:timeline-marked-as-draft:1-0-0', TimelineMarkedAsDraftV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:timeline-marked-as-draft', TimelineMarkedAsDraftV1);

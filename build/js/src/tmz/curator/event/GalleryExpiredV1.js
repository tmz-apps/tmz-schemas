...
export default class GalleryExpiredV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:gallery-expired:1-0-0', GalleryExpiredV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:gallery-expired', GalleryExpiredV1);

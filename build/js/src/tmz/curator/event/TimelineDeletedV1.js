...
export default class TimelineDeletedV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:event:timeline-deleted:1-0-0', TimelineDeletedV1,
      [],
      [
...
MessageResolver.register('tmz:curator:event:timeline-deleted', TimelineDeletedV1);

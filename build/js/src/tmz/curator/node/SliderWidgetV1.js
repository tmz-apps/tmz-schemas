// @link https://schemas.tmz.com/json-schema/tmz/curator/node/slider-widget/1-0-0.json#
...
export default class SliderWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:slider-widget:1-0-0', SliderWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:slider-widget', SliderWidgetV1);

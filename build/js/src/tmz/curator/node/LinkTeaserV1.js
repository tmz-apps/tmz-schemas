// @link https://schemas.tmz.com/json-schema/tmz/curator/node/link-teaser/1-0-0.json#
...
export default class LinkTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:link-teaser:1-0-0', LinkTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:link-teaser', LinkTeaserV1);

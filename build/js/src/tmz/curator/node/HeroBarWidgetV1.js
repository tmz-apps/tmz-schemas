// @link https://schemas.tmz.com/json-schema/tmz/curator/node/hero-bar-widget/1-0-0.json#
...
export default class HeroBarWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:hero-bar-widget:1-0-0', HeroBarWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:hero-bar-widget', HeroBarWidgetV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/youtube-video-teaser/1-0-0.json#
...
export default class YoutubeVideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:youtube-video-teaser:1-0-0', YoutubeVideoTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:youtube-video-teaser', YoutubeVideoTeaserV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/gallery-teaser/1-0-0.json#
...
export default class GalleryTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:gallery-teaser:1-0-0', GalleryTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:gallery-teaser', GalleryTeaserV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/media-list-widget/1-0-0.json#
...
export default class MediaListWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:media-list-widget:1-0-0', MediaListWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:media-list-widget', MediaListWidgetV1);

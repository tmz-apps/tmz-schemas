// @link https://schemas.tmz.com/json-schema/tmz/curator/node/page-teaser/1-0-0.json#
...
export default class PageTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:page-teaser:1-0-0', PageTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:page-teaser', PageTeaserV1);

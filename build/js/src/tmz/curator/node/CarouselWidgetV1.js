// @link https://schemas.tmz.com/json-schema/tmz/curator/node/carousel-widget/1-0-0.json#
...
export default class CarouselWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:carousel-widget:1-0-0', CarouselWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:carousel-widget', CarouselWidgetV1);

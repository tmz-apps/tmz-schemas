// @link https://schemas.tmz.com/json-schema/tmz/curator/node/playlist-widget/1-0-0.json#
...
export default class PlaylistWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:playlist-widget:1-0-0', PlaylistWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:playlist-widget', PlaylistWidgetV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/spotlight-widget/1-0-0.json#
...
export default class SpotlightWidgetV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:spotlight-widget:1-0-0', SpotlightWidgetV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:spotlight-widget', SpotlightWidgetV1);

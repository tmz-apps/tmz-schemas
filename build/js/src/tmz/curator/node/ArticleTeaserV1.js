// @link https://schemas.tmz.com/json-schema/tmz/curator/node/article-teaser/1-0-0.json#
...
export default class ArticleTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:article-teaser:1-0-0', ArticleTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:article-teaser', ArticleTeaserV1);

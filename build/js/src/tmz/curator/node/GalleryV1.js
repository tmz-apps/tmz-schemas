// @link https://schemas.tmz.com/json-schema/tmz/curator/node/gallery/1-0-0.json#
...
export default class GalleryV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:gallery:1-0-0', GalleryV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:gallery', GalleryV1);

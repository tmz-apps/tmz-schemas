// @link https://schemas.tmz.com/json-schema/tmz/curator/node/video-teaser/1-0-0.json#
...
export default class VideoTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:video-teaser:1-0-0', VideoTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:video-teaser', VideoTeaserV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/channel-teaser/1-0-0.json#
...
export default class ChannelTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:channel-teaser:1-0-0', ChannelTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:channel-teaser', ChannelTeaserV1);

// @link https://schemas.tmz.com/json-schema/tmz/curator/node/person-teaser/1-0-0.json#
...
export default class PersonTeaserV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:node:person-teaser:1-0-0', PersonTeaserV1,
      [],
      [
...
MessageResolver.register('tmz:curator:node:person-teaser', PersonTeaserV1);

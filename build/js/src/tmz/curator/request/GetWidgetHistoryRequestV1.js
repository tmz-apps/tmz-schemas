...
export default class GetWidgetHistoryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:get-widget-history-request:1-0-0', GetWidgetHistoryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:get-widget-history-request', GetWidgetHistoryRequestV1);

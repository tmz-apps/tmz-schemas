...
export default class GetTeaserRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:get-teaser-request:1-0-0', GetTeaserRequestV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:get-teaser-request', GetTeaserRequestV1);

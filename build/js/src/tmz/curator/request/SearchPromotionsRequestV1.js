...
export default class SearchPromotionsRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:search-promotions-request:1-0-0', SearchPromotionsRequestV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:search-promotions-request', SearchPromotionsRequestV1);

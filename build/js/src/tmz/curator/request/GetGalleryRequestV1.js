...
export default class GetGalleryRequestV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:get-gallery-request:1-0-0', GetGalleryRequestV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:get-gallery-request', GetGalleryRequestV1);

...
export default class GetWidgetResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:get-widget-response:1-0-0', GetWidgetResponseV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:get-widget-response', GetWidgetResponseV1);

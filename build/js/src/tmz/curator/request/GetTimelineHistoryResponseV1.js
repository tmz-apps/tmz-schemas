...
export default class GetTimelineHistoryResponseV1 extends Message {
   ...
   */
  static defineSchema() {
    return new Schema('pbj:tmz:curator:request:get-timeline-history-response:1-0-0', GetTimelineHistoryResponseV1,
      [],
      [
...
MessageResolver.register('tmz:curator:request:get-timeline-history-response', GetTimelineHistoryResponseV1);

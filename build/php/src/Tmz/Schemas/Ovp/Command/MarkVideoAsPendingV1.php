...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:mark-video-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:mark-video-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:mark-video-as-pending:v1';
    const MIXINS = [

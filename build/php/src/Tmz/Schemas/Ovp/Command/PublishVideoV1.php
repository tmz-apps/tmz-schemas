...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:publish-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:publish-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:publish-video:v1';
    const MIXINS = [

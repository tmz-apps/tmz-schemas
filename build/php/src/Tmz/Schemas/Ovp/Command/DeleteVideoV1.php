...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:delete-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:delete-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:delete-video:v1';
    const MIXINS = [

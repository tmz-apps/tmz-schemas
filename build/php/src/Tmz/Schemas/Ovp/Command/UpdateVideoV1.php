...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:update-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:update-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:update-video:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:create-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:create-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:create-video:v1';
    const MIXINS = [

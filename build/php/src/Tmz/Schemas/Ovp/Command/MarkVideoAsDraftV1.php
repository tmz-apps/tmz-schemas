...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:mark-video-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:mark-video-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:mark-video-as-draft:v1';
    const MIXINS = [

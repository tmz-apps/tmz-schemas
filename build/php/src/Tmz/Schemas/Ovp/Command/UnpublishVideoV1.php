...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:unpublish-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:unpublish-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:unpublish-video:v1';
    const MIXINS = [

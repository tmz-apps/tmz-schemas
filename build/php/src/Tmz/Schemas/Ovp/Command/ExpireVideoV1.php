...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:expire-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:expire-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:expire-video:v1';
    const MIXINS = [

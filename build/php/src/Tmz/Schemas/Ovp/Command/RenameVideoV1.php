...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:command:rename-video:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:command:rename-video';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:command:rename-video:v1';
    const MIXINS = [

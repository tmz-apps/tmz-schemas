...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:search-videos-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:search-videos-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:search-videos-response:v1';
    const MIXINS = [

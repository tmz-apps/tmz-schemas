...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:search-videos-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:search-videos-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:search-videos-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:get-video-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:get-video-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:get-video-request:v1';
    const MIXINS = [

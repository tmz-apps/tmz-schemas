...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:get-video-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:get-video-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:get-video-history-response:v1';
    const MIXINS = [

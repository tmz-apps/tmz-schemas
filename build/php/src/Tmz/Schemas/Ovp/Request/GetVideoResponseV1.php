...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:get-video-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:get-video-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:get-video-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:request:get-video-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:request:get-video-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:request:get-video-history-request:v1';
    const MIXINS = [

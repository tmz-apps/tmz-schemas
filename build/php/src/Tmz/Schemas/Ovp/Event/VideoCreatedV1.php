...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-created:v1';
    const MIXINS = [

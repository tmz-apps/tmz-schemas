...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-expired:v1';
    const MIXINS = [

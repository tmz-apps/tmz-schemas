...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-unpublished:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-marked-as-pending:v1';
    const MIXINS = [

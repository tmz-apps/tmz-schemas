...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-scheduled:v1';
    const MIXINS = [

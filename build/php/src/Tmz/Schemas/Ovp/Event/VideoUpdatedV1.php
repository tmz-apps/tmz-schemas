...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-updated:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-marked-as-draft:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-published:v1';
    const MIXINS = [

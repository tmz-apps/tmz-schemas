...
{
    const SCHEMA_ID = 'pbj:tmz:ovp:event:video-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:ovp:event:video-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:ovp:event:video-renamed:v1';
    const MIXINS = [

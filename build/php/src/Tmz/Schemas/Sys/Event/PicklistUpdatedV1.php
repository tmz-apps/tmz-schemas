...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:picklist-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:picklist-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:picklist-updated:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:flagset-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:flagset-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:flagset-deleted:v1';
    const MIXINS = [

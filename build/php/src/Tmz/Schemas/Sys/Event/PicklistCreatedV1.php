...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:picklist-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:picklist-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:picklist-created:v1';
    const MIXINS = [

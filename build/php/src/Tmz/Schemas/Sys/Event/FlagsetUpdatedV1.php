...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:flagset-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:flagset-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:flagset-updated:v1';
    const MIXINS = [

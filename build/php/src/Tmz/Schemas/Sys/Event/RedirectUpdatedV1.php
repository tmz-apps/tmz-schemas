...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:redirect-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:redirect-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:redirect-updated:v1';
    const MIXINS = [

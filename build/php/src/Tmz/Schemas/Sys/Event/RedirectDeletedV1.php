...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:redirect-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:redirect-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:redirect-deleted:v1';
    const MIXINS = [

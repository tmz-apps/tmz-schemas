...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:redirect-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:redirect-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:redirect-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:flagset-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:flagset-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:flagset-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:event:picklist-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:event:picklist-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:event:picklist-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-picklist-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-picklist-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-picklist-response:v1';
    const MIXINS = [

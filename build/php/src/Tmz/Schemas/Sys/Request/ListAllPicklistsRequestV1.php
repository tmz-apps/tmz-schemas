...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:list-all-picklists-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:list-all-picklists-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:list-all-picklists-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:search-redirects-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:search-redirects-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:search-redirects-response:v1';
    const MIXINS = [

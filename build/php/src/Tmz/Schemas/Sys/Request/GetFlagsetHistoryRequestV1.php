...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-flagset-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-flagset-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-flagset-history-request:v1';
    const MIXINS = [

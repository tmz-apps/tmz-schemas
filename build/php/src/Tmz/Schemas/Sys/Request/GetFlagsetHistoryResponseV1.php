...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-flagset-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-flagset-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-flagset-history-response:v1';
    const MIXINS = [

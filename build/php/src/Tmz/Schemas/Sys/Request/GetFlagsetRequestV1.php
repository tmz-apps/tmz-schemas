...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-flagset-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-flagset-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-flagset-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-redirect-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-redirect-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-redirect-response:v1';
    const MIXINS = [

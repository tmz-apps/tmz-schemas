...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-redirect-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-redirect-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-redirect-request:v1';
    const MIXINS = [

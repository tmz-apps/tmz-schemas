...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:list-all-picklists-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:list-all-picklists-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:list-all-picklists-response:v1';
    const MIXINS = [

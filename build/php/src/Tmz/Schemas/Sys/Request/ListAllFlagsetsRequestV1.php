...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:list-all-flagsets-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:list-all-flagsets-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:list-all-flagsets-request:v1';
    const MIXINS = [

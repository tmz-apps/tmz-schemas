...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:list-all-flagsets-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:list-all-flagsets-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:list-all-flagsets-response:v1';
    const MIXINS = [

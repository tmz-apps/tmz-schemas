...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:search-redirects-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:search-redirects-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:search-redirects-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:request:get-picklist-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:request:get-picklist-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:request:get-picklist-history-request:v1';
    const MIXINS = [

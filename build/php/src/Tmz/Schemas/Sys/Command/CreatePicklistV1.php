...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:create-picklist:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:create-picklist';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:create-picklist:v1';
    const MIXINS = [

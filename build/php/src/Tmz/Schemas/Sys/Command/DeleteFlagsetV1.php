...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:delete-flagset:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:delete-flagset';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:delete-flagset:v1';
    const MIXINS = [

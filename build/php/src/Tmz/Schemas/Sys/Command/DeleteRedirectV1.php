...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:delete-redirect:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:delete-redirect';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:delete-redirect:v1';
    const MIXINS = [

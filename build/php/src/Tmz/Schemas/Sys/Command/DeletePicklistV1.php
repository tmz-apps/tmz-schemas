...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:delete-picklist:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:delete-picklist';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:delete-picklist:v1';
    const MIXINS = [

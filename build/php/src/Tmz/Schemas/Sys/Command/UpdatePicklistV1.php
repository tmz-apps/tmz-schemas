...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:update-picklist:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:update-picklist';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:update-picklist:v1';
    const MIXINS = [

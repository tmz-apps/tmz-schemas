...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:update-redirect:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:update-redirect';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:update-redirect:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:create-redirect:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:create-redirect';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:create-redirect:v1';
    const MIXINS = [

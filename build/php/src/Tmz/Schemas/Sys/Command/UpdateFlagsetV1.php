...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:update-flagset:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:update-flagset';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:update-flagset:v1';
    const MIXINS = [

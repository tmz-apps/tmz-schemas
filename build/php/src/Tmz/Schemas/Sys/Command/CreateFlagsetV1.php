...
{
    const SCHEMA_ID = 'pbj:tmz:sys:command:create-flagset:1-0-0';
    const SCHEMA_CURIE = 'tmz:sys:command:create-flagset';
    const SCHEMA_CURIE_MAJOR = 'tmz:sys:command:create-flagset:v1';
    const MIXINS = [

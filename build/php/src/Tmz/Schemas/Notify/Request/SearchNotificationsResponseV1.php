...
{
    const SCHEMA_ID = 'pbj:tmz:notify:request:search-notifications-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:request:search-notifications-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:request:search-notifications-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:request:search-notifications-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:request:search-notifications-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:request:search-notifications-request:v1';
    const MIXINS = [

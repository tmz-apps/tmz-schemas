...
{
    const SCHEMA_ID = 'pbj:tmz:notify:request:get-notification-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:request:get-notification-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:request:get-notification-history-request:v1';
    const MIXINS = [

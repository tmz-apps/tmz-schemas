...
{
    const SCHEMA_ID = 'pbj:tmz:notify:request:get-notification-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:request:get-notification-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:request:get-notification-history-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:request:get-notification-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:request:get-notification-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:request:get-notification-request:v1';
    const MIXINS = [

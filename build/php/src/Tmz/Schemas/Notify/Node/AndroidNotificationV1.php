...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:android-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:android-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:android-notification:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:twitter-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:twitter-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:twitter-notification:v1';
    const MIXINS = [

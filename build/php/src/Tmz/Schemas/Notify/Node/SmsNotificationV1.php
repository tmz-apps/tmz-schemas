...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:sms-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:sms-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:sms-notification:v1';
    const MIXINS = [

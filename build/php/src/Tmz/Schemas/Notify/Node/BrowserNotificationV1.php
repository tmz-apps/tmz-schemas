...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:browser-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:browser-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:browser-notification:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:apple-news-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:apple-news-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:apple-news-notification:v1';
    const MIXINS = [

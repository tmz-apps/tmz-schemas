...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:ios-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:ios-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:ios-notification:v1';
    const MIXINS = [

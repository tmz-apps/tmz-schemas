...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:slack-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:slack-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:slack-notification:v1';
    const MIXINS = [

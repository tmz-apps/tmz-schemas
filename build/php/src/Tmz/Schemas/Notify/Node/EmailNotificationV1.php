...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:email-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:email-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:email-notification:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:node:alexa-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:node:alexa-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:node:alexa-notification:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:command:send-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:command:send-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:command:send-notification:v1';
    const MIXINS = [

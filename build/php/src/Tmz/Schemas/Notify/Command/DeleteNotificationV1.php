...
{
    const SCHEMA_ID = 'pbj:tmz:notify:command:delete-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:command:delete-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:command:delete-notification:v1';
    const MIXINS = [

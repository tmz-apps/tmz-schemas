...
{
    const SCHEMA_ID = 'pbj:tmz:notify:command:update-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:command:update-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:command:update-notification:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:command:create-notification:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:command:create-notification';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:command:create-notification:v1';
    const MIXINS = [

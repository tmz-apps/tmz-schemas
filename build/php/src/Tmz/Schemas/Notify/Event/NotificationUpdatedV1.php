...
{
    const SCHEMA_ID = 'pbj:tmz:notify:event:notification-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:event:notification-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:event:notification-updated:v1';
    const MIXINS = [

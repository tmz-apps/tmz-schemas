...
{
    const SCHEMA_ID = 'pbj:tmz:notify:event:notification-sent:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:event:notification-sent';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:event:notification-sent:v1';
    const MIXINS = [

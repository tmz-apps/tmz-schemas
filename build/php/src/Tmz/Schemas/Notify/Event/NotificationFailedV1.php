...
{
    const SCHEMA_ID = 'pbj:tmz:notify:event:notification-failed:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:event:notification-failed';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:event:notification-failed:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:event:notification-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:event:notification-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:event:notification-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:notify:event:notification-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:notify:event:notification-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:notify:event:notification-deleted:v1';
    const MIXINS = [

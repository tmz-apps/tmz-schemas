...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-expired:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-deleted:v1';
    const MIXINS = [

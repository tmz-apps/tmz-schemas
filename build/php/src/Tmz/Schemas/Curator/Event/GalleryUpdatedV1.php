...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-updated:v1';
    const MIXINS = [

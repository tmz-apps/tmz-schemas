...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-deleted:v1';
    const MIXINS = [

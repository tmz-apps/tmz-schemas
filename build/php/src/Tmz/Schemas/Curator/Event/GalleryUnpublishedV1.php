...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-unpublished:v1';
    const MIXINS = [

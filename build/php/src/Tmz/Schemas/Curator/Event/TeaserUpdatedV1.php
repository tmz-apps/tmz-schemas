...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-updated:v1';
    const MIXINS = [

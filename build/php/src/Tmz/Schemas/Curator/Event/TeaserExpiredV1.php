...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-expired:v1';
    const MIXINS = [

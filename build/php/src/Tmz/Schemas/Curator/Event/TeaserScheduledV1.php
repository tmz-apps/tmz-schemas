...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-scheduled:v1';
    const MIXINS = [

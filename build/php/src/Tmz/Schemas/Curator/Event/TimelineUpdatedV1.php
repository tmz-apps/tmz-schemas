...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-updated:v1';
    const MIXINS = [

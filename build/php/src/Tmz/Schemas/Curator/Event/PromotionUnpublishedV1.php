...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-unpublished:v1';
    const MIXINS = [

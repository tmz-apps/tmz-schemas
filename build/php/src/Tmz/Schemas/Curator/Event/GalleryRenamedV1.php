...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-renamed:v1';
    const MIXINS = [

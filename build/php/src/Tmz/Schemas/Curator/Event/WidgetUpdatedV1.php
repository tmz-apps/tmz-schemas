...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:widget-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:widget-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:widget-updated:v1';
    const MIXINS = [

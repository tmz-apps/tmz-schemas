...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-published:v1';
    const MIXINS = [

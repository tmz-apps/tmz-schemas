...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-deleted:v1';
    const MIXINS = [

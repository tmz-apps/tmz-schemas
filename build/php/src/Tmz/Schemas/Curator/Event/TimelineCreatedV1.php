...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-created:v1';
    const MIXINS = [

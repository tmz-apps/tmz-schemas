...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-marked-as-draft:v1';
    const MIXINS = [

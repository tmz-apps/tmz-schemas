...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-scheduled:v1';
    const MIXINS = [

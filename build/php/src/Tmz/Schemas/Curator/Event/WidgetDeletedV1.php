...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:widget-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:widget-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:widget-deleted:v1';
    const MIXINS = [

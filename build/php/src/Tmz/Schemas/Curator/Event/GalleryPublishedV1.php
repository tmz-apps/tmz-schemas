...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-published:v1';
    const MIXINS = [

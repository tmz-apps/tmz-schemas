...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-unpublished:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-renamed:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-scheduled:v1';
    const MIXINS = [

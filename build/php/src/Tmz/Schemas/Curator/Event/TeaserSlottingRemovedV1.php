...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-slotting-removed:v1';
    const MIXINS = [

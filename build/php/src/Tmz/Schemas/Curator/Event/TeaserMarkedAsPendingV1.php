...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-marked-as-pending:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-published:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-scheduled:v1';
    const MIXINS = [

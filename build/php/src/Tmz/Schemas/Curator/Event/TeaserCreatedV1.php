...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-created:v1';
    const MIXINS = [

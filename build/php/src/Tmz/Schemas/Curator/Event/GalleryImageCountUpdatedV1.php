...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-image-count-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-image-count-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-image-count-updated:v1';
    const MIXINS = [

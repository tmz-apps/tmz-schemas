...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-unpublished:v1';
    const MIXINS = [

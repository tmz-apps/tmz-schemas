...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:widget-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:widget-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:widget-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-created:v1';
    const MIXINS = [

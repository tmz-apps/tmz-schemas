...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:promotion-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:promotion-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:promotion-updated:v1';
    const MIXINS = [

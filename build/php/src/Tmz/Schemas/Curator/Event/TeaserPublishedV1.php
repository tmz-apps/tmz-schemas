...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:teaser-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:teaser-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:teaser-published:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:gallery-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:gallery-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:gallery-expired:v1';
    const MIXINS = [

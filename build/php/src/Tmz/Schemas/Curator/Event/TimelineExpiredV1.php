...
{
    const SCHEMA_ID = 'pbj:tmz:curator:event:timeline-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:event:timeline-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:event:timeline-expired:v1';
    const MIXINS = [

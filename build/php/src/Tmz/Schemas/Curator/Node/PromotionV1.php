...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:promotion:v1';
    const MIXINS = [

...
use Triniti\Schemas\Curator\Mixin\LiveBlogUpdateTeaser\LiveBlogUpdateTeaserV1Mixin as TrinitiCuratorLiveBlogUpdateTeaserV1Mixin;

final class LiveBlogUpdateTeaserV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:live-blog-update-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:live-blog-update-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:live-blog-update-teaser:v1';
    const MIXINS = [
    ...
    use TrinitiCuratorLiveBlogUpdateTeaserV1Mixin;

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:person-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:person-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:person-teaser:v1';
    const MIXINS = [

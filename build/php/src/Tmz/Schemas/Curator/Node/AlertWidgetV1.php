...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:alert-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:alert-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:alert-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:spotlight-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:spotlight-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:spotlight-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:gridler-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:gridler-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:gridler-widget:v1';
    const MIXINS = [

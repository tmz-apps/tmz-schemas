...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:link-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:link-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:link-teaser:v1';
    const MIXINS = [

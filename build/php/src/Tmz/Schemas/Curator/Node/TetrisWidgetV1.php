...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:tetris-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:tetris-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:tetris-widget:v1';
    const MIXINS = [

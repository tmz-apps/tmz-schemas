...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:youtube-video-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:youtube-video-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:youtube-video-teaser:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:video-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:video-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:video-teaser:v1';
    const MIXINS = [

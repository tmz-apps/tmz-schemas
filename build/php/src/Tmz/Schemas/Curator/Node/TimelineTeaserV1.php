...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:timeline-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:timeline-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:timeline-teaser:v1';
    const MIXINS = [

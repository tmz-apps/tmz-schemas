...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:poll-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:poll-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:poll-teaser:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:showtimes-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:showtimes-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:showtimes-widget:v1';
    const MIXINS = [

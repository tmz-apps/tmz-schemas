<?php
// @link http://schemas.tmz.com/json-schema/tmz/curator/node/showtimes-widget/1-0-0.json#
    ...
    TrinitiCommonThemeableV1
{
    ...
    {
        return new Schema('pbj:tmz:curator:node:showtimes-widget:1-0-0', __CLASS__,
            [],
            [

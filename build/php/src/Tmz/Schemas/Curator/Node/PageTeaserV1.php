...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:page-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:page-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:page-teaser:v1';
    const MIXINS = [

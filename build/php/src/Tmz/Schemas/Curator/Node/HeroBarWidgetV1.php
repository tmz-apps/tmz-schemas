...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:hero-bar-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:hero-bar-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:hero-bar-widget:v1';
    const MIXINS = [

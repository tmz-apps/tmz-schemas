...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:blogroll-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:blogroll-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:blogroll-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:gallery-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:gallery-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:gallery-widget:v1';
    const MIXINS = [

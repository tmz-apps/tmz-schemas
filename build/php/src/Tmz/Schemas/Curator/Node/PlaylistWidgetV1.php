...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:playlist-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:playlist-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:playlist-widget:v1';
    const MIXINS = [

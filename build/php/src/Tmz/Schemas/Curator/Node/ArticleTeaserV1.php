...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:article-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:article-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:article-teaser:v1';
    const MIXINS = [

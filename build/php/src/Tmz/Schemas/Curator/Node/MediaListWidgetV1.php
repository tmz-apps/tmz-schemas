...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:media-list-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:media-list-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:media-list-widget:v1';
    const MIXINS = [

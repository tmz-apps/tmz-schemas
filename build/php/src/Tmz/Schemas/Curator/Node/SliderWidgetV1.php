...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:slider-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:slider-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:slider-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:code-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:code-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:code-widget:v1';
    const MIXINS = [

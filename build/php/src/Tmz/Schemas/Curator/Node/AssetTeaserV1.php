...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:asset-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:asset-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:asset-teaser:v1';
    const MIXINS = [

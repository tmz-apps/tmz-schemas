...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:carousel-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:carousel-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:carousel-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:ad-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:ad-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:ad-widget:v1';
    const MIXINS = [

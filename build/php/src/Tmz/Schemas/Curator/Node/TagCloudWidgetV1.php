...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:tag-cloud-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:tag-cloud-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:tag-cloud-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:channel-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:channel-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:channel-teaser:v1';
    const MIXINS = [

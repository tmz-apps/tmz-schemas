<?php
// @link http://schemas.tmz.com/json-schema/tmz/curator/node/category-teaser/1-0-0.json#
    ...
    TrinitiTaxonomyHashtaggableV1
{
    ...
    {
        return new Schema('pbj:tmz:curator:node:category-teaser:1-0-0', __CLASS__,
            [],
            [

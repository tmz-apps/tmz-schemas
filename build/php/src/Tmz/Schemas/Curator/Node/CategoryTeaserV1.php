...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:category-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:category-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:category-teaser:v1';
    const MIXINS = [

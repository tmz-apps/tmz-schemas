...
{
    const SCHEMA_ID = 'pbj:tmz:curator:node:gallery-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:node:gallery-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:node:gallery-teaser:v1';
    const MIXINS = [

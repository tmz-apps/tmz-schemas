...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:get-promotion-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:get-promotion-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:get-promotion-history-response:v1';
    const MIXINS = [

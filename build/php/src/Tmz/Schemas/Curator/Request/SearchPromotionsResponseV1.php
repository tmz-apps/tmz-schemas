...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:search-promotions-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:search-promotions-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:search-promotions-response:v1';
    const MIXINS = [

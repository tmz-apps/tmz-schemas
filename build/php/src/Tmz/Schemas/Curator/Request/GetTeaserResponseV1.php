...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:get-teaser-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:get-teaser-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:get-teaser-response:v1';
    const MIXINS = [

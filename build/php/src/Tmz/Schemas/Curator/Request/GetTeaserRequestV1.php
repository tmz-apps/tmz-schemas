...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:get-teaser-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:get-teaser-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:get-teaser-request:v1';
    const MIXINS = [

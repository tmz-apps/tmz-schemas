...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:search-teasers-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:search-teasers-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:search-teasers-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:get-widget-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:get-widget-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:get-widget-request:v1';
    const MIXINS = [

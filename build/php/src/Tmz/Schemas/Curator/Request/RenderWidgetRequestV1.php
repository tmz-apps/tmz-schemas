...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:render-widget-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:render-widget-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:render-widget-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:search-galleries-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:search-galleries-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:search-galleries-request:v1';
    const MIXINS = [

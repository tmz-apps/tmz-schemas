...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:search-promotions-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:search-promotions-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:search-promotions-request:v1';
    const MIXINS = [

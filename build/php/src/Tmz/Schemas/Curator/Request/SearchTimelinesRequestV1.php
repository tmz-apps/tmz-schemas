...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:search-timelines-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:search-timelines-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:search-timelines-request:v1';
    const MIXINS = [

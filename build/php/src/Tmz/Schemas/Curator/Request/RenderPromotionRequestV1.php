...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:render-promotion-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:render-promotion-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:render-promotion-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:request:get-gallery-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:request:get-gallery-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:request:get-gallery-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:unpublish-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:unpublish-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:unpublish-timeline:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:create-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:create-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:create-promotion:v1';
    const MIXINS = [

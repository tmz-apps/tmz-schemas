...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:unpublish-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:unpublish-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:unpublish-promotion:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:remove-teaser-slotting:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:remove-teaser-slotting';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:remove-teaser-slotting:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:delete-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:delete-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:delete-widget:v1';
    const MIXINS = [

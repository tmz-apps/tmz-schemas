...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:publish-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:publish-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:publish-timeline:v1';
    const MIXINS = [

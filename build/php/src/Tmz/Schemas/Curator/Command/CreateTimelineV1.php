...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:create-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:create-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:create-timeline:v1';
    const MIXINS = [

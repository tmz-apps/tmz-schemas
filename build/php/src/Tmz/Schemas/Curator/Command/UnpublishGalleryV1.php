...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:unpublish-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:unpublish-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:unpublish-gallery:v1';
    const MIXINS = [

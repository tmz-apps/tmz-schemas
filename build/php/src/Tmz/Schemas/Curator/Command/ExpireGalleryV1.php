...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:expire-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:expire-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:expire-gallery:v1';
    const MIXINS = [

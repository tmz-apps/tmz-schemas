...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:delete-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:delete-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:delete-gallery:v1';
    const MIXINS = [

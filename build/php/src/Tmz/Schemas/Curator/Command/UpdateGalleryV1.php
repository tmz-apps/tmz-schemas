...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-gallery:v1';
    const MIXINS = [

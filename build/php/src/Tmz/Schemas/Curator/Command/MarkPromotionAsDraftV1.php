...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:mark-promotion-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:mark-promotion-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:mark-promotion-as-draft:v1';
    const MIXINS = [

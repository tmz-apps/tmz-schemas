...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:publish-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:publish-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:publish-gallery:v1';
    const MIXINS = [

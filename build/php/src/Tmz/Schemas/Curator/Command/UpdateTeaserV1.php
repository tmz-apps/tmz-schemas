...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-teaser:v1';
    const MIXINS = [

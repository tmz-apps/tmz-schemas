...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:delete-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:delete-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:delete-timeline:v1';
    const MIXINS = [

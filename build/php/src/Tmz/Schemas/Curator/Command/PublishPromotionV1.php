...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:publish-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:publish-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:publish-promotion:v1';
    const MIXINS = [

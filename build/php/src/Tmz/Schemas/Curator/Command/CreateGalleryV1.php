...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:create-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:create-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:create-gallery:v1';
    const MIXINS = [

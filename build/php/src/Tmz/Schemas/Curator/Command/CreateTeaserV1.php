...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:create-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:create-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:create-teaser:v1';
    const MIXINS = [

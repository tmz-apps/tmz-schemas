...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:create-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:create-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:create-widget:v1';
    const MIXINS = [

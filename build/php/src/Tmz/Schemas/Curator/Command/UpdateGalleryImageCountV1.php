...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-gallery-image-count:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-gallery-image-count';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-gallery-image-count:v1';
    const MIXINS = [

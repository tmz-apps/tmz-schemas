...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:expire-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:expire-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:expire-promotion:v1';
    const MIXINS = [

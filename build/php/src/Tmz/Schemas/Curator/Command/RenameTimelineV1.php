...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:rename-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:rename-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:rename-timeline:v1';
    const MIXINS = [

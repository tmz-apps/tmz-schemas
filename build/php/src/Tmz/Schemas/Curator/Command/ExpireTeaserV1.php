...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:expire-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:expire-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:expire-teaser:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-timeline:v1';
    const MIXINS = [

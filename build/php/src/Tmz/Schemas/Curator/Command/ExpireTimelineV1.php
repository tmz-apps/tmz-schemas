...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:expire-timeline:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:expire-timeline';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:expire-timeline:v1';
    const MIXINS = [

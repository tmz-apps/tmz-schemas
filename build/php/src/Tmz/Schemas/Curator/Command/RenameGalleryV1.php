...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:rename-gallery:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:rename-gallery';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:rename-gallery:v1';
    const MIXINS = [

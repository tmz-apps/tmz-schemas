...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:publish-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:publish-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:publish-teaser:v1';
    const MIXINS = [

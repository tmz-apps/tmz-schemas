...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-widget:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-widget';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-widget:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:unpublish-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:unpublish-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:unpublish-teaser:v1';
    const MIXINS = [

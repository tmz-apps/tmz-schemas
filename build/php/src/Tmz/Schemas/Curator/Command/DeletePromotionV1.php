...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:delete-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:delete-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:delete-promotion:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:sync-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:sync-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:sync-teaser:v1';
    const MIXINS = [

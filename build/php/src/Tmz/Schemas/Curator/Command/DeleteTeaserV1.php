...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:delete-teaser:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:delete-teaser';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:delete-teaser:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:mark-gallery-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:mark-gallery-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:mark-gallery-as-pending:v1';
    const MIXINS = [

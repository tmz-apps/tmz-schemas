...
{
    const SCHEMA_ID = 'pbj:tmz:curator:command:update-promotion:1-0-0';
    const SCHEMA_CURIE = 'tmz:curator:command:update-promotion';
    const SCHEMA_CURIE_MAJOR = 'tmz:curator:command:update-promotion:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:delete-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:delete-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:delete-sponsor:v1';
    const MIXINS = [

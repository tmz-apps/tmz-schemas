...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:expire-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:expire-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:expire-sponsor:v1';
    const MIXINS = [

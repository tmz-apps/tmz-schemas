...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:create-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:create-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:create-sponsor:v1';
    const MIXINS = [

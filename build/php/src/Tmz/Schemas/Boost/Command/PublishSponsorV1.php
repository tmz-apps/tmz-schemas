...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:publish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:publish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:publish-sponsor:v1';
    const MIXINS = [

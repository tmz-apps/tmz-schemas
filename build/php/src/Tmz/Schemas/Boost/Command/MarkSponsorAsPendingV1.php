...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:mark-sponsor-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:mark-sponsor-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:mark-sponsor-as-pending:v1';
    const MIXINS = [

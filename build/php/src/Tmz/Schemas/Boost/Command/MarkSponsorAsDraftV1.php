...
namespace Tmz\Schemas\Boost\Command;
...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:mark-sponsor-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:mark-sponsor-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:mark-sponsor-as-draft:v1';
    const MIXINS = [

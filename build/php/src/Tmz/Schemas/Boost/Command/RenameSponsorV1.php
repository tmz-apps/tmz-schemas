...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:rename-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:rename-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:rename-sponsor:v1';
    const MIXINS = [

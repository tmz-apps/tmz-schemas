<?php
// @link http://schemas.tmz.com/json-schema/tmz/boost/command/unpublish-sponsor/1-0-0.json#
    ...
    GdbotsNcrUnpublishNodeV1
{
    ...
    {
        return new Schema('pbj:tmz:boost:command:unpublish-sponsor:1-0-0', __CLASS__,
            [],
            [

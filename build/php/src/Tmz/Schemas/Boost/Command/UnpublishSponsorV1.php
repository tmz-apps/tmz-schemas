...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:unpublish-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:unpublish-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:unpublish-sponsor:v1';
    const MIXINS = [

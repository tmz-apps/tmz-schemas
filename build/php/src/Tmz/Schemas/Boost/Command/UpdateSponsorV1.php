...
{
    const SCHEMA_ID = 'pbj:tmz:boost:command:update-sponsor:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:command:update-sponsor';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:command:update-sponsor:v1';
    const MIXINS = [

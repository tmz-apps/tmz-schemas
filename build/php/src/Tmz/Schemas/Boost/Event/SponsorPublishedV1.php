...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-published:v1';
    const MIXINS = [

...
namespace Tmz\Schemas\Boost\Event;
...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-marked-as-pending:v1';
    const MIXINS = [

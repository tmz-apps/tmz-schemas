...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-deleted:v1';
    const MIXINS = [

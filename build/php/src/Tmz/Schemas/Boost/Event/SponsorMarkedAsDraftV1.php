...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-marked-as-draft:v1';
    const MIXINS = [

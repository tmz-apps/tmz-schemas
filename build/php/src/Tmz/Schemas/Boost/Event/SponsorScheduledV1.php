...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-scheduled:v1';
    const MIXINS = [

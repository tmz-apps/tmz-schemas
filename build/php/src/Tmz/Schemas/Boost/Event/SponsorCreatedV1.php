...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-created:v1';
    const MIXINS = [

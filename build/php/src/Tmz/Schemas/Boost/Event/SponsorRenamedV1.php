...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-renamed:v1';
    const MIXINS = [

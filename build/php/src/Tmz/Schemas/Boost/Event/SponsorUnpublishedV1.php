...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-unpublished:v1';
    const MIXINS = [

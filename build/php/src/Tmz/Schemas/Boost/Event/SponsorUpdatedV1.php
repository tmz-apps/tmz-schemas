...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-updated:v1';
    const MIXINS = [

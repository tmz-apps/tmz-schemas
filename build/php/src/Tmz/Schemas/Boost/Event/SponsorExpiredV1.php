...
{
    const SCHEMA_ID = 'pbj:tmz:boost:event:sponsor-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:event:sponsor-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:event:sponsor-expired:v1';
    const MIXINS = [

...
namespace Tmz\Schemas\Boost\Request;
...
{
    const SCHEMA_ID = 'pbj:tmz:boost:request:get-sponsor-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:request:get-sponsor-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:request:get-sponsor-history-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:boost:request:search-sponsors-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:request:search-sponsors-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:request:search-sponsors-request:v1';
    const MIXINS = [

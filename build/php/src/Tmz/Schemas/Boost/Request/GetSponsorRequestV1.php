...
{
    const SCHEMA_ID = 'pbj:tmz:boost:request:get-sponsor-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:request:get-sponsor-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:request:get-sponsor-request:v1';
    const MIXINS = [

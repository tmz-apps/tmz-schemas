...
{
    const SCHEMA_ID = 'pbj:tmz:boost:request:get-sponsor-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:request:get-sponsor-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:request:get-sponsor-history-request:v1';
    const MIXINS = [

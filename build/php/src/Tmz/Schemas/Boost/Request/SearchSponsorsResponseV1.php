...
{
    const SCHEMA_ID = 'pbj:tmz:boost:request:search-sponsors-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:boost:request:search-sponsors-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:boost:request:search-sponsors-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:mark-page-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:mark-page-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:mark-page-as-draft:v1';
    const MIXINS = [

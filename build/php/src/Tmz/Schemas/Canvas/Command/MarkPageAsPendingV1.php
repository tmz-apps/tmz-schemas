...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:mark-page-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:mark-page-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:mark-page-as-pending:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:create-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:create-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:create-page:v1';
    const MIXINS = [

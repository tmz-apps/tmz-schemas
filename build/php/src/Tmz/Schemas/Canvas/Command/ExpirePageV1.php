...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:expire-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:expire-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:expire-page:v1';
    const MIXINS = [

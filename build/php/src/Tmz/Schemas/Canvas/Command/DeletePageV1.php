...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:delete-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:delete-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:delete-page:v1';
    const MIXINS = [

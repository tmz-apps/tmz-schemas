...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:publish-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:publish-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:publish-page:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:rename-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:rename-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:rename-page:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:unpublish-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:unpublish-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:unpublish-page:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:command:update-page:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:command:update-page';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:command:update-page:v1';
    const MIXINS = [

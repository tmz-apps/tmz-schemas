...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:soundcloud-audio-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:soundcloud-audio-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:soundcloud-audio-block:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:instagram-media-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:instagram-media-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:instagram-media-block:v1';
    const MIXINS = [

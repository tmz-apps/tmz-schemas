...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:document-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:document-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:document-block:v1';
    const MIXINS = [

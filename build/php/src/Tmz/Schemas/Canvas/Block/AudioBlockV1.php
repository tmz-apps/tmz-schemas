...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:audio-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:audio-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:audio-block:v1';
    const MIXINS = [

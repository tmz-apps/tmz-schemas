...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:pinterest-pin-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:pinterest-pin-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:pinterest-pin-block:v1';
    const MIXINS = [

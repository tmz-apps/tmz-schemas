...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:spotify-embed-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:spotify-embed-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:spotify-embed-block:v1';
    const MIXINS = [

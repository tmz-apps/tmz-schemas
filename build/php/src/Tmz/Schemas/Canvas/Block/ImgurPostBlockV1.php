...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:imgur-post-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:imgur-post-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:imgur-post-block:v1';
    const MIXINS = [

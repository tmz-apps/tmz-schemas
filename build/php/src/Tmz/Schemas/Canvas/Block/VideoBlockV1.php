...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:video-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:video-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:video-block:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:divider-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:divider-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:divider-block:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:article-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:article-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:article-block:v1';
    const MIXINS = [

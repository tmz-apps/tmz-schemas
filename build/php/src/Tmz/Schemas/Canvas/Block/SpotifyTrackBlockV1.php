...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:spotify-track-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:spotify-track-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:spotify-track-block:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:block:quote-block:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:block:quote-block';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:block:quote-block:v1';
    const MIXINS = [

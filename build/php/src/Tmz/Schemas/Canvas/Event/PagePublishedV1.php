...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-published:v1';
    const MIXINS = [

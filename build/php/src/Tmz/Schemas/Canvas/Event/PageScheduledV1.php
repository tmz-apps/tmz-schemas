...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-scheduled:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-updated:v1';
    const MIXINS = [

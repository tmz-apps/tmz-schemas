...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-expired:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-renamed:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-unpublished:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-marked-as-draft:v1';
    const MIXINS = [

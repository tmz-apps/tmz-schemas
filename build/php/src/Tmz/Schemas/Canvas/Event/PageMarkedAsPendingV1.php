<?php
// @link http://schemas.tmz.com/json-schema/tmz/canvas/event/page-marked-as-pending/1-0-0.json#
    ...
    GdbotsNcrNodeMarkedAsPendingV1
{
    ...
    {
        return new Schema('pbj:tmz:canvas:event:page-marked-as-pending:1-0-0', __CLASS__,
            [],
            [

...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:event:page-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:event:page-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:event:page-marked-as-pending:v1';
    const MIXINS = [

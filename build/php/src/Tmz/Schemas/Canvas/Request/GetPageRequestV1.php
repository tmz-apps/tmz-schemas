...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:get-page-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:get-page-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:get-page-request:v1';
    const MIXINS = [

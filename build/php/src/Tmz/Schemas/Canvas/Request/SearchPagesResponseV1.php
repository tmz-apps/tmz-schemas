...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:search-pages-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:search-pages-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:search-pages-response:v1';
    const MIXINS = [

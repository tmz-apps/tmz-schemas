...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:get-page-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:get-page-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:get-page-response:v1';
    const MIXINS = [

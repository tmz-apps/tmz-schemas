...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:get-page-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:get-page-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:get-page-history-request:v1';
    const MIXINS = [

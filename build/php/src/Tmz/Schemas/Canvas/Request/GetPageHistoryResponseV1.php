...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:get-page-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:get-page-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:get-page-history-response:v1';
    const MIXINS = [

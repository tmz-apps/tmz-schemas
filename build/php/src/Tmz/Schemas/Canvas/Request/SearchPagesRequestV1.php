...
{
    const SCHEMA_ID = 'pbj:tmz:canvas:request:search-pages-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:canvas:request:search-pages-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:canvas:request:search-pages-request:v1';
    const MIXINS = [

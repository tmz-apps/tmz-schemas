...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:node:category:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:node:category';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:node:category:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:update-category:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:update-category';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:update-category:v1';
    const MIXINS = [

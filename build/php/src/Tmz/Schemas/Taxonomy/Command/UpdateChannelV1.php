...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:update-channel:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:update-channel';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:update-channel:v1';
    const MIXINS = [

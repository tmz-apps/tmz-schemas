...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:delete-channel:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:delete-channel';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:delete-channel:v1';
    const MIXINS = [

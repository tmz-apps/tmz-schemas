...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:rename-category:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:rename-category';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:rename-category:v1';
    const MIXINS = [

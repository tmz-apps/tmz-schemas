...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:delete-category:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:delete-category';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:delete-category:v1';
    const MIXINS = [

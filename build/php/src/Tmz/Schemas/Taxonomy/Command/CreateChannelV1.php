...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:create-channel:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:create-channel';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:create-channel:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:create-category:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:create-category';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:create-category:v1';
    const MIXINS = [

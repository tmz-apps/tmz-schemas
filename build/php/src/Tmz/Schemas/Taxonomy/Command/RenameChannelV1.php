<?php
// @link http://schemas.tmz.com/json-schema/tmz/taxonomy/command/rename-channel/1-0-0.json#
    ...
    GdbotsNcrRenameNodeV1
{
    ...
    {
        return new Schema('pbj:tmz:taxonomy:command:rename-channel:1-0-0', __CLASS__,
            [],
            [

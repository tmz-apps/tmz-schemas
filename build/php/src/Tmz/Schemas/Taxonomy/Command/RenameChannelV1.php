...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:command:rename-channel:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:command:rename-channel';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:command:rename-channel:v1';
    const MIXINS = [

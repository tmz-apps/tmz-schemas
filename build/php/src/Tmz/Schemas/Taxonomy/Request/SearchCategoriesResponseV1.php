...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:search-categories-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:search-categories-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:search-categories-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:suggest-hashtags-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:suggest-hashtags-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:suggest-hashtags-response:v1';
    const MIXINS = [

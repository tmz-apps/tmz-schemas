...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:search-categories-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:search-categories-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:search-categories-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:get-category-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:get-category-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:get-category-request:v1';
    const MIXINS = [

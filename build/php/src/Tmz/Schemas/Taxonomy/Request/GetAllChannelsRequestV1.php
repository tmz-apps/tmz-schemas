...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:get-all-channels-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:get-all-channels-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:get-all-channels-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:get-category-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:get-category-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:get-category-response:v1';
    const MIXINS = [

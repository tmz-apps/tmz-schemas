...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:get-all-channels-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:get-all-channels-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:get-all-channels-response:v1';
    const MIXINS = [

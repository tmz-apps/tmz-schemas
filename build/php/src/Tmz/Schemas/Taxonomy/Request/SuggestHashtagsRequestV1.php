...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:suggest-hashtags-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:suggest-hashtags-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:suggest-hashtags-request:v1';
    const MIXINS = [

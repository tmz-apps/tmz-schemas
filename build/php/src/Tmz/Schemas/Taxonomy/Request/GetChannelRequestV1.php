...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:request:get-channel-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:request:get-channel-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:request:get-channel-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:channel-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:channel-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:channel-renamed:v1';
    const MIXINS = [

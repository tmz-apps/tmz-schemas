...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:category-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:category-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:category-renamed:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:channel-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:channel-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:channel-updated:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:category-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:category-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:category-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:channel-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:channel-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:channel-deleted:v1';
    const MIXINS = [

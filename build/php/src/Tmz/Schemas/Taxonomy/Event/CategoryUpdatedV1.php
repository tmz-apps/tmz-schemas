...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:category-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:category-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:category-updated:v1';
    const MIXINS = [

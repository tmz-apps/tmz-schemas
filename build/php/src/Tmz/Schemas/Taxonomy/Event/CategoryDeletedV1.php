...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:category-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:category-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:category-deleted:v1';
    const MIXINS = [

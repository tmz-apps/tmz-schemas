...
{
    const SCHEMA_ID = 'pbj:tmz:taxonomy:event:channel-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:taxonomy:event:channel-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:taxonomy:event:channel-created:v1';
    const MIXINS = [

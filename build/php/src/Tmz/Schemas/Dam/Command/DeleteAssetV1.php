...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:delete-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:delete-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:delete-asset:v1';
    const MIXINS = [

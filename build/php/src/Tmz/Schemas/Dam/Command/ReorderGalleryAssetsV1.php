...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:reorder-gallery-assets:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:reorder-gallery-assets';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:reorder-gallery-assets:v1';
    const MIXINS = [

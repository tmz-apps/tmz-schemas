...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:expire-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:expire-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:expire-asset:v1';
    const MIXINS = [

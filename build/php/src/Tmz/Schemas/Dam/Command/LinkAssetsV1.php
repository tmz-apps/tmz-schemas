...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:link-assets:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:link-assets';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:link-assets:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:update-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:update-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:update-asset:v1';
    const MIXINS = [

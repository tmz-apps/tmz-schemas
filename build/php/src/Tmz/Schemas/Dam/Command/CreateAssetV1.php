...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:create-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:create-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:create-asset:v1';
    const MIXINS = [

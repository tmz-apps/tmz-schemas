...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:patch-assets:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:patch-assets';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:patch-assets:v1';
    const MIXINS = [

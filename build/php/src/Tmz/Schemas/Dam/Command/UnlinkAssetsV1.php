...
{
    const SCHEMA_ID = 'pbj:tmz:dam:command:unlink-assets:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:command:unlink-assets';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:command:unlink-assets:v1';
    const MIXINS = [

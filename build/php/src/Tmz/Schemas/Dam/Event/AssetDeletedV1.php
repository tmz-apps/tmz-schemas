...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-deleted:v1';
    const MIXINS = [

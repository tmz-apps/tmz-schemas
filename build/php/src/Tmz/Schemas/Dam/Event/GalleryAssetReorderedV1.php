...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:gallery-asset-reordered:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:gallery-asset-reordered';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:gallery-asset-reordered:v1';
    const MIXINS = [

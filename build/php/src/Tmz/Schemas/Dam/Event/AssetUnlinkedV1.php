...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-unlinked:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-unlinked';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-unlinked:v1';
    const MIXINS = [

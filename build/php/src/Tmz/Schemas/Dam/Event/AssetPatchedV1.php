...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-patched:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-patched';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-patched:v1';
    const MIXINS = [

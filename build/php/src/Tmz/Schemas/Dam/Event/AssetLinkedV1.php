...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-linked:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-linked';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-linked:v1';
    const MIXINS = [

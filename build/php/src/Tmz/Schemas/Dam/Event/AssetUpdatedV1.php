...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-updated:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-expired:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:dam:event:asset-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:event:asset-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:event:asset-created:v1';
    const MIXINS = [

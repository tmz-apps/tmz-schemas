...
{
    const SCHEMA_ID = 'pbj:tmz:dam:node:unknown-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:node:unknown-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:node:unknown-asset:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:dam:node:document-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:node:document-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:node:document-asset:v1';
    const MIXINS = [

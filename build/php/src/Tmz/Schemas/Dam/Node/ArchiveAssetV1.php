...
{
    const SCHEMA_ID = 'pbj:tmz:dam:node:archive-asset:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:node:archive-asset';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:node:archive-asset:v1';
    const MIXINS = [

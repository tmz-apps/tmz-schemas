...
{
    const SCHEMA_ID = 'pbj:tmz:dam:request:search-assets-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:request:search-assets-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:request:search-assets-response:v1';
    const MIXINS = [

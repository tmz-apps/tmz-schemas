...
{
    const SCHEMA_ID = 'pbj:tmz:dam:request:search-assets-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:request:search-assets-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:request:search-assets-request:v1';
    const MIXINS = [

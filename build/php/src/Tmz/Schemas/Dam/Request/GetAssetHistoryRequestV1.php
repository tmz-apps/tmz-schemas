...
{
    const SCHEMA_ID = 'pbj:tmz:dam:request:get-asset-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:request:get-asset-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:request:get-asset-history-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:dam:request:get-asset-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:request:get-asset-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:request:get-asset-history-response:v1';
    const MIXINS = [

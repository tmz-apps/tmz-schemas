...
{
    const SCHEMA_ID = 'pbj:tmz:dam:request:get-upload-urls-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:dam:request:get-upload-urls-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:dam:request:get-upload-urls-response:v1';
    const MIXINS = [

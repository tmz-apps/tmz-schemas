...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:user-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:user-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:user-roles-revoked:v1';
    const MIXINS = [

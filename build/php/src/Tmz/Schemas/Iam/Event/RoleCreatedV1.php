...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:role-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:role-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:role-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:user-roles-granted:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:user-roles-granted';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:user-roles-granted:v1';
    const MIXINS = [

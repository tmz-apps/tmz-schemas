...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:user-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:user-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:user-created:v1';
    const MIXINS = [

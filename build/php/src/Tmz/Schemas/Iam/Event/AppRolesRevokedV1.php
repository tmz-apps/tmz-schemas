...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:app-roles-revoked:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:app-roles-revoked';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:app-roles-revoked:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:role-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:role-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:role-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:user-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:user-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:user-deleted:v1';
    const MIXINS = [

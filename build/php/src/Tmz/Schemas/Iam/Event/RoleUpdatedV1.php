...
{
    const SCHEMA_ID = 'pbj:tmz:iam:event:role-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:event:role-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:event:role-updated:v1';
    const MIXINS = [

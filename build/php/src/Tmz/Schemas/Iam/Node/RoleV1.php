...
namespace Tmz\Schemas\Iam\Node;
...
{
    const SCHEMA_ID = 'pbj:tmz:iam:node:role:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:node:role';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:node:role:v1';
    const MIXINS = [

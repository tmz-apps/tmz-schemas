...
{
    const SCHEMA_ID = 'pbj:tmz:iam:node:apple-news-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:node:apple-news-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:node:apple-news-app:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-app-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-app-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-app-response:v1';
    const MIXINS = [

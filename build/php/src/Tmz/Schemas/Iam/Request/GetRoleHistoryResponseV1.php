...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-role-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-role-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-role-history-response:v1';
    const MIXINS = [

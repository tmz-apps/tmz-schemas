...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:search-users-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:search-users-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:search-users-request:v1';
    const MIXINS = [

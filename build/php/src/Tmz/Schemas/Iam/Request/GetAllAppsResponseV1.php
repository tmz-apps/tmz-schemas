...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-all-apps-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-all-apps-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-all-apps-response:v1';
    const MIXINS = [

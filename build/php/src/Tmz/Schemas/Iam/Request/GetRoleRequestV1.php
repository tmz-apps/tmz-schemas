...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-role-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-role-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-role-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-app-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-app-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-app-history-request:v1';
    const MIXINS = [

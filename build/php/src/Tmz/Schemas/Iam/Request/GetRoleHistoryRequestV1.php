...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-role-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-role-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-role-history-request:v1';
    const MIXINS = [

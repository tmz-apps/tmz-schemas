...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-user-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-user-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-user-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:list-all-roles-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:list-all-roles-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:list-all-roles-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:list-all-roles-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:list-all-roles-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:list-all-roles-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:search-users-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:search-users-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:search-users-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-user-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-user-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-user-history-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:request:get-user-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:request:get-user-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:request:get-user-request:v1';
    const MIXINS = [

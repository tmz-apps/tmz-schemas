...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:update-role:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:update-role';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:update-role:v1';
    const MIXINS = [

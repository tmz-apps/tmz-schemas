...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:revoke-roles-from-user:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:revoke-roles-from-user';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:revoke-roles-from-user:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:delete-role:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:delete-role';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:delete-role:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:grant-roles-to-user:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:grant-roles-to-user';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:grant-roles-to-user:v1';
    const MIXINS = [

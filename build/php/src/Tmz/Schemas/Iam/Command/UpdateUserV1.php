...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:update-user:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:update-user';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:update-user:v1';
    const MIXINS = [

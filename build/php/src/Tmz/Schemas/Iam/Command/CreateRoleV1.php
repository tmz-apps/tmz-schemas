...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:create-role:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:create-role';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:create-role:v1';
    const MIXINS = [

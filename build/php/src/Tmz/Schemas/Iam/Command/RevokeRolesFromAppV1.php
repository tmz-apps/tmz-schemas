...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:revoke-roles-from-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:revoke-roles-from-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:revoke-roles-from-app:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:delete-user:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:delete-user';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:delete-user:v1';
    const MIXINS = [

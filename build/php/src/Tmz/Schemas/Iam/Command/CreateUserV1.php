...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:create-user:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:create-user';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:create-user:v1';
    const MIXINS = [

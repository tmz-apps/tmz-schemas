...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:update-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:update-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:update-app:v1';
    const MIXINS = [

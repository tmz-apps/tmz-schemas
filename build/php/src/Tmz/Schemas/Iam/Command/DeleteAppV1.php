...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:delete-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:delete-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:delete-app:v1';
    const MIXINS = [

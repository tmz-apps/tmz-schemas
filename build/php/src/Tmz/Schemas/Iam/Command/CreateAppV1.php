...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:create-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:create-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:create-app:v1';
    const MIXINS = [

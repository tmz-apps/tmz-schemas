...
{
    const SCHEMA_ID = 'pbj:tmz:iam:command:grant-roles-to-app:1-0-0';
    const SCHEMA_CURIE = 'tmz:iam:command:grant-roles-to-app';
    const SCHEMA_CURIE_MAJOR = 'tmz:iam:command:grant-roles-to-app:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:apple-news-article-synced:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:apple-news-article-synced';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:apple-news-article-synced:v1';
    const MIXINS = [

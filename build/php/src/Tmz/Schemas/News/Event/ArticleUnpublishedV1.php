...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-unpublished:v1';
    const MIXINS = [

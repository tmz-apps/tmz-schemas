...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-slotting-removed:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-slotting-removed';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-slotting-removed:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-deleted:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-marked-as-draft:v1';
    const MIXINS = [

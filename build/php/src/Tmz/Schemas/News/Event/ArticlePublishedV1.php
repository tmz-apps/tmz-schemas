...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-published:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-scheduled:v1';
    const MIXINS = [

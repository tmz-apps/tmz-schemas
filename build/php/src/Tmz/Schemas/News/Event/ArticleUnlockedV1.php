...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-unlocked:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-unlocked';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-unlocked:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-updated:v1';
    const MIXINS = [

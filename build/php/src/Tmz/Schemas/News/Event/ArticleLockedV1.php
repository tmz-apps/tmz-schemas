...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-locked:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-locked';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-locked:v1';
    const MIXINS = [

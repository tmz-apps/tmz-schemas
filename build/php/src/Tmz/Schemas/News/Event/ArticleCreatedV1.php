...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-renamed:v1';
    const MIXINS = [

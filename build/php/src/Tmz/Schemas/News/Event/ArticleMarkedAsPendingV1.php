...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-marked-as-pending:v1';
    const MIXINS = [

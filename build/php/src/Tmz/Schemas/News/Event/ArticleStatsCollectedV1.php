...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-stats-collected:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-stats-collected';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-stats-collected:v1';
    const MIXINS = [

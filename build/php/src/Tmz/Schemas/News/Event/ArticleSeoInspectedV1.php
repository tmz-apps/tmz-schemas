...
namespace Tmz\Schemas\News\Event;
...
final class ArticleSeoInspectedV1 extends AbstractMessage
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-seo-inspected:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-seo-inspected';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-seo-inspected:v1';
    const MIXINS = [
    ...
    use TrinitiSysSeoInspectedV1Mixin;

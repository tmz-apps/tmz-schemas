...
{
    const SCHEMA_ID = 'pbj:tmz:news:event:article-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:event:article-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:event:article-expired:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:request:get-article-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:request:get-article-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:request:get-article-response:v1';
    const MIXINS = [

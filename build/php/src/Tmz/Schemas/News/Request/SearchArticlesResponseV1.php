...
{
    const SCHEMA_ID = 'pbj:tmz:news:request:search-articles-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:request:search-articles-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:request:search-articles-response:v1';
    const MIXINS = [

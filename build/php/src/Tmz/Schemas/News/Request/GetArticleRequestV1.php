...
{
    const SCHEMA_ID = 'pbj:tmz:news:request:get-article-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:request:get-article-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:request:get-article-request:v1';
    const MIXINS = [

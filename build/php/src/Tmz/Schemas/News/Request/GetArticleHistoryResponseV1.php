...
{
    const SCHEMA_ID = 'pbj:tmz:news:request:get-article-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:request:get-article-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:request:get-article-history-response:v1';
    const MIXINS = [

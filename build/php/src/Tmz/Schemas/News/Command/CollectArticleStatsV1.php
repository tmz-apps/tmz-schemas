...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:collect-article-stats:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:collect-article-stats';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:collect-article-stats:v1';
    const MIXINS = [

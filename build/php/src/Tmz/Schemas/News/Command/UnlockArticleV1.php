...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:unlock-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:unlock-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:unlock-article:v1';
    const MIXINS = [

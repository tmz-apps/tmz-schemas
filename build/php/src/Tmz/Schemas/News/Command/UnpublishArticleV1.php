...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:unpublish-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:unpublish-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:unpublish-article:v1';
    const MIXINS = [

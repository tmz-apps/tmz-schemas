...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:publish-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:publish-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:publish-article:v1';
    const MIXINS = [

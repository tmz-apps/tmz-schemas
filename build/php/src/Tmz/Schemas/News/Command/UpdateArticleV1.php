...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:update-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:update-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:update-article:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:remove-article-slotting:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:remove-article-slotting';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:remove-article-slotting:v1';
    const MIXINS = [

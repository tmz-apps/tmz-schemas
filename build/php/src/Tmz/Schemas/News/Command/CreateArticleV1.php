...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:create-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:create-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:create-article:v1';
    const MIXINS = [

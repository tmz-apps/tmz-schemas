...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:rename-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:rename-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:rename-article:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:expire-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:expire-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:expire-article:v1';
    const MIXINS = [

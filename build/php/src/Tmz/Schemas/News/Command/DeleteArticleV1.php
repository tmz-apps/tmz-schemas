...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:delete-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:delete-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:delete-article:v1';
    const MIXINS = [

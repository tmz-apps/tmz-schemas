...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:mark-article-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:mark-article-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:mark-article-as-draft:v1';
    const MIXINS = [

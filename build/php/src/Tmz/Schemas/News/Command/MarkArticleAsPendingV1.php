...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:mark-article-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:mark-article-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:mark-article-as-pending:v1';
    const MIXINS = [

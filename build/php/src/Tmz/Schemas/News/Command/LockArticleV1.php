...
{
    const SCHEMA_ID = 'pbj:tmz:news:command:lock-article:1-0-0';
    const SCHEMA_CURIE = 'tmz:news:command:lock-article';
    const SCHEMA_CURIE_MAJOR = 'tmz:news:command:lock-article:v1';
    const MIXINS = [

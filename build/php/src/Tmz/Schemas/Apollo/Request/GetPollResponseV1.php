...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:get-poll-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:get-poll-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:get-poll-response:v1';
    const MIXINS = [

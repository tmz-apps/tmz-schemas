...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:get-poll-history-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:get-poll-history-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:get-poll-history-response:v1';
    const MIXINS = [

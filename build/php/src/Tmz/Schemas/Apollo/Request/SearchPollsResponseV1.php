...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:search-polls-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:search-polls-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:search-polls-response:v1';
    const MIXINS = [

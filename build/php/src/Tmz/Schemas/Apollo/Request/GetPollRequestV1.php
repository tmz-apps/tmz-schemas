...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:get-poll-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:get-poll-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:get-poll-request:v1';
    const MIXINS = [

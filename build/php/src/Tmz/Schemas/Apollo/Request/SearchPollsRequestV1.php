...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:search-polls-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:search-polls-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:search-polls-request:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:request:get-poll-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:request:get-poll-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:request:get-poll-history-request:v1';
    const MIXINS = [

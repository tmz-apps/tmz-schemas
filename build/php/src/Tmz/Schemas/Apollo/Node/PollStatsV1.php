...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:node:poll-stats:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:node:poll-stats';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:node:poll-stats:v1';
    const MIXINS = [

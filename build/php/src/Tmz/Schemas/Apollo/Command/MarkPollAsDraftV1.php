...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:mark-poll-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:mark-poll-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:mark-poll-as-draft:v1';
    const MIXINS = [

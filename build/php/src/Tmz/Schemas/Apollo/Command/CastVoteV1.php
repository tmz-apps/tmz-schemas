...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:cast-vote:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:cast-vote';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:cast-vote:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:unpublish-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:unpublish-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:unpublish-poll:v1';
    const MIXINS = [

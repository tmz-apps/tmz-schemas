...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:publish-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:publish-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:publish-poll:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:expire-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:expire-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:expire-poll:v1';
    const MIXINS = [

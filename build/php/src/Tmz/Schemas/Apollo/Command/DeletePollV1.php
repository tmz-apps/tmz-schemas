...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:delete-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:delete-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:delete-poll:v1';
    const MIXINS = [

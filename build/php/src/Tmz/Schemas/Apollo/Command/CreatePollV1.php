...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:create-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:create-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:create-poll:v1';
    const MIXINS = [

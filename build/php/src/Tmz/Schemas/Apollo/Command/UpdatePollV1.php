...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:update-poll:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:update-poll';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:update-poll:v1';
    const MIXINS = [

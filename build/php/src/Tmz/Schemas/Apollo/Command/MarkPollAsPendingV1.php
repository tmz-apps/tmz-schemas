...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:command:mark-poll-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:command:mark-poll-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:command:mark-poll-as-pending:v1';
    const MIXINS = [

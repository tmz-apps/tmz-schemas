...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-unpublished:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-unpublished';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-unpublished:v1';
    const MIXINS = [

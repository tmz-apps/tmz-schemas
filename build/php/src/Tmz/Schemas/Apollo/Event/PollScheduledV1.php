...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-scheduled:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-scheduled';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-scheduled:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-updated:v1';
    const MIXINS = [

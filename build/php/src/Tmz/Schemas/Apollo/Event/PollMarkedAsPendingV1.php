...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-marked-as-pending:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-marked-as-pending';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-marked-as-pending:v1';
    const MIXINS = [

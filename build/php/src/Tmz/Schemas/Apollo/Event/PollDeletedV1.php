...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-deleted:v1';
    const MIXINS = [

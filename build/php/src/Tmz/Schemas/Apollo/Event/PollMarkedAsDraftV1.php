...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-marked-as-draft:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-marked-as-draft';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-marked-as-draft:v1';
    const MIXINS = [

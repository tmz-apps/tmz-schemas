...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-published:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-published';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-published:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-created:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:apollo:event:poll-expired:1-0-0';
    const SCHEMA_CURIE = 'tmz:apollo:event:poll-expired';
    const SCHEMA_CURIE_MAJOR = 'tmz:apollo:event:poll-expired:v1';
    const MIXINS = [

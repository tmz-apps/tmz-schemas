...
{
    const SCHEMA_ID = 'pbj:tmz:people:command:create-person:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:command:create-person';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:command:create-person:v1';
    const MIXINS = [

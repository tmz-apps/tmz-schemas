...
{
    const SCHEMA_ID = 'pbj:tmz:people:command:rename-person:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:command:rename-person';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:command:rename-person:v1';
    const MIXINS = [

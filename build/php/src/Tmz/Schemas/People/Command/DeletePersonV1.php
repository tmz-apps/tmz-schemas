...
{
    const SCHEMA_ID = 'pbj:tmz:people:command:delete-person:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:command:delete-person';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:command:delete-person:v1';
    const MIXINS = [

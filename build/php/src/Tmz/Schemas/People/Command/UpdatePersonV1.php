...
{
    const SCHEMA_ID = 'pbj:tmz:people:command:update-person:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:command:update-person';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:command:update-person:v1';
    const MIXINS = [

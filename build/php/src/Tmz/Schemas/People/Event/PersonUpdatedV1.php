...
{
    const SCHEMA_ID = 'pbj:tmz:people:event:person-updated:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:event:person-updated';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:event:person-updated:v1';
    const MIXINS = [

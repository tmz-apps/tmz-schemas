...
{
    const SCHEMA_ID = 'pbj:tmz:people:event:person-created:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:event:person-created';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:event:person-created:v1';
    const MIXINS = [

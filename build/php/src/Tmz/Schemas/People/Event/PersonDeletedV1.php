...
{
    const SCHEMA_ID = 'pbj:tmz:people:event:person-deleted:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:event:person-deleted';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:event:person-deleted:v1';
    const MIXINS = [

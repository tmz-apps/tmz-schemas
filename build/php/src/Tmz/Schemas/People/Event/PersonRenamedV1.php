...
{
    const SCHEMA_ID = 'pbj:tmz:people:event:person-renamed:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:event:person-renamed';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:event:person-renamed:v1';
    const MIXINS = [

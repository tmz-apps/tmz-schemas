...
{
    const SCHEMA_ID = 'pbj:tmz:people:request:search-people-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:request:search-people-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:request:search-people-response:v1';
    const MIXINS = [

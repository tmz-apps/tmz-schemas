...
{
    const SCHEMA_ID = 'pbj:tmz:people:request:get-person-response:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:request:get-person-response';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:request:get-person-response:v1';
    const MIXINS = [

...
{
    const SCHEMA_ID = 'pbj:tmz:people:request:get-person-history-request:1-0-0';
    const SCHEMA_CURIE = 'tmz:people:request:get-person-history-request';
    const SCHEMA_CURIE_MAJOR = 'tmz:people:request:get-person-history-request:v1';
    const MIXINS = [
